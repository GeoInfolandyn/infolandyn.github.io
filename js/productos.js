...
// listas de los elementos por clase
    ...
    var listA2 =['MOD09Q1 NDVI 250m 8 Days Time Series','MOD09A1 NDVI 500m Ecuador Time Series','AVHRR NDVI Time Series', "SENTINEL-2 NDVI 10m GUADALQUITÓN Time Series"]
    var listA3 =['MOD09Q1 NDVI 250m Time Series filtered','MOD09A1 NDVI 500m Time Series Filtered','MOD09A1 NDVI 500m ECUADOR Time Series Filtered',"SENTINEL-2 NDVI 10m GUADALQUITÓN Time Series Filtered"]
...
function filtroB(){
    ...
    var op2 = document.getElementById("OP2");
// listas de los elementos por clase
    var listB1 =['AUTOCORRELATION FUNCTION (NDVI 250m MOD09Q1)', 'AUTOCORRELATION FUNCTION (NDVI 500m MOD09A1)', 'PERIODOGRAM AVHRR-NDVI',"AUTOCORRELATION FUNCTION (SENTINEL-2) GUADALQUITÓN"]
